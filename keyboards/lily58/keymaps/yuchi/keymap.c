 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_A,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
 ...
 */
  ...
  XXXXXXX, XXXXXXX, RGB_SAI, XXXXXXX, RGB_HUI, RGB_VAI,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, RGB_SAD, RGB_TOG, RGB_HUD, RGB_VAD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             _______, _______, _______, _______, _______,  _______, _______, _______
  )
};
